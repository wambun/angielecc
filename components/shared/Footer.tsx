...
export const Footer = ({ className }: { className?: string }) => {
  ...
  return (
    <footer className={`bg-[#0f1c1f] ${className || ''}`}>
      {/* Main Footer Content */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 bg-[#1a2e35] rounded-full flex items-center justify-center text-gray-400 hover:text-[#c8ff00] hover:bg-[#243d44] transition-colors"
              >
